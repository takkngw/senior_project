...
class RobotEnvironment:
    def __init__(self, robot):
        ...
        self.goal_position = [0, 0.1, -0.15] # 目標Z座標
    ...
    def get_state(self):
        ...
        relative_goal_pos = np.array(self.goal_position) - current_pos
    ...
    def is_done(self):
        ...
        if current_pos[1] >= self.goal_position[1]: # 参考ファイルに基づきZ座標で判定
            self.goal_position[1] += 0.02
            if self.goal_position[1] > 20.0:
                self.goal_position[1] = 20.0
        ...
        # if abs(current_pos[0]) > 2 or abs(current_pos[0]) > 5:
...
def main():
    ...
    config = {
        ...
        'target_update': 200, 'memory_size': 150000
    }
