...
class HexapodEnv:
    ...
    def __init__(self, robot, num_joints=18):
        ...
        self.goal_y_position = 0.3 # Y方向に5m進むのが目標
    ...
    def calculate_reward(self):
        ...
        print(f"Velocity Y: {velocity_y:.4f} m/s")
...
def main():
    ...
    config = {
        ...
        'epsilon_min': 0.01, 'epsilon_decay': 0.9995, 'batch_size': 128,
